        ...
        <div className="w-full h-16 bg-[#313131] border-black rounded-full">
            <div className="flex flex-row relative">
                ...
                <div className="mt-3 ml-4 absolute right-10 flex flex-row">
                    <button className="rounded-xl bg-[#313131] text-white hover:bg-[#555555] px-4 py-2 border-2 border-white mr-5">
                        Sign Up
                    </button>
                    <button className="rounded-xl bg-white text-black hover:bg-[#aaaaaa] px-4 py-2 border-2 border-white mr-5">
                        Log In
                    </button>
                </div>
